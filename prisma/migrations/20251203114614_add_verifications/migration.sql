-- CreateEnum
CREATE TYPE "ReactionType" AS ENUM ('BELIEVED', 'LAUGHED', 'THOUGHTFUL', 'MASTERPIECE');
...
CREATE TABLE "articles" (
    ...
    "funnyScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "realityScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "creativityScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "reactions_articleId_userId_type_key" ON "reactions"("articleId", "userId", "type");
